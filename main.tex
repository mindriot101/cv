...
\EducationEntry{Post-doctoral Research Associate}{Jan 2014-present}{University
  of Warwick, Full-time}{Continuing from my Ph.D., I continued to work with the
  NGTS project, designing and implementing software for the main analysis
  pipeline. This included routinely processing ~70GB of data per night to search
  for extrasolar planets, assessent and monitoring of the analysis pipeline data
  quality, and visualisation of the pipeline quality. I have also been leading
  an distributed team, in the further development of data techniques and tools,
  involving members in multiple time zones, and coordinating our efforts.}
...
\EducationEntry{Ph.D. in Astrophysics}{Sep 2009 - Sep 2013}{University of
  ...
  analysis pipelines, with which I characterised the noise properties, and
  influenced the final design of the instrument. I also applied ensemble
  analysis techniques to planets found with the WASP project, to compute the
  occurrence rate of Jupiter-like planets.}
\sepspace

\EducationEntry{MPhys. in Physics}{Sep 2005 - Sep 2009}{University of Warwick}{}
